...
class ManiacalMaze:
        ...
        if event.type == QUIT:
            ...
            if adjust:
                ...
                if self.success:
                    ...
                    text = font.render('You win! Hit enter to reset', True, (255,0,0), (255,255,255))
                    
                    # create a rectangular object for the
                    # text surface object
                    textRect = text.get_rect()
                    # set the center of the rectangular object.
                    textRect.center = (750 // 2, 400 // 2)
    ...
    def draw_dynamic_cell(self,x,y,celltype,top_buffer,left_buffer,cell_x,cell_y,current):
        ...
        #print( 'X/Y: '+str(x)+'/'+str(y)+'  Cell: '+str(celltype)+'  Buffers'+str(top_buffer)+'/'+str(left_buffer)+        '  Cell X/Y'+str(cell_x)+' '+str(cell_y)+'   Current: '+str(current))
        ...
        if celltype & self.bit_l:
            ...
            pygame.draw.rect(self.screen, color, rect)
        pygame.display.flip()
        #print('Cell: '+str(x)+":"+str(y)+"="+str(celltype))
        return True
